...
class ClubController extends AbstractController
{
    ...
    public function listFormation()
    {
        $var1="3A32";
        $var2="J12";
        $tab_formations=array(array('ref' => 'form147', 'Titre' => 'Formation Symfony4','Description'=>'formation pratique','date_debut'=>'12/06/2020', 'date_fin'=>'19/06/2020','nb_participants'=>19),
        ...
        return $this->render("club/list.html.twig",array("tableau_formations"=>$tab_formations));
        
    }

    #[Route('/getname', name: 'get_name')]
    public function getName(string $nom)
    {

      return $this->render("/club/get{$nom}");
    }
